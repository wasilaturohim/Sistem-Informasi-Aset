                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="<?= base_url('Admin/cPenyusutan/detail/' . $value->id_asset) ?>" class="btn btn-danger"> <i class="fas fa-level-down-alt"></i> Detail Transaksi</a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php
